...
VALUES 
 (1, 1, 'admin1', 'admin1', N'Nguyễn Văn A', 'nguyenvana@example.com', '1234567890'),
 (2, 1, 'admin2', 'admin2', N'Lê Thị B', 'lethib@example.com', '9876543210'),
 (3, 1, 'admin3', 'admin3', N'Trần Văn C', 'tranvanc@example.com', '4567890123'),
 (4, 2, 'manager1', 'manager1', N'Nguyễn Thị D', 'nguyenthid@example.com', '7890123456'),
 (5, 2, 'manager2', 'manager2', N'Phạm Văn E', 'phamvane@example.com', '2345678901'),
 (6, 2, 'manager3', 'manager3', N'Hoàng Thị F', 'hoangthif@example.com', '9012345678'),
 (7, 3, 'staff1', 'staff1', N'Võ Văn G', 'vovang@example.com', '3456789012'),
 (8, 3, 'staff2', 'staff2', N'Đặng Thị H', 'dangthih@example.com', '6789012345'),
 (9, 3, 'staff3', 'staff3', N'Trương Văn I', 'truongvani@example.com', '0123456789'),
 (10, 3, 'staff4', 'staff4', N'Nguyễn Thị K', 'nguyenthik@example.com', '8901234567')
...
SELECT Cars.car_id, Cars.name AS car_name, Categories.title AS category_title, Locations.address, Cars.detail, Cars.registration_number, Cars.image, Cars.price_per_day, Cars.status
FROM Cars 
