...
public class ManageStatisticControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Staff> listStaff = adao.getAllStaff();
        ...
        //out.println(xe);
        List<Customer> listCustomer = adao.getAllCustomer();
        int customer = listCustomer.size();
        List<Staff> listWorker = adao.getAllWorker();
        int worker = listWorker.size();
        List<Rental> listRental = rdao.getAllRental();
