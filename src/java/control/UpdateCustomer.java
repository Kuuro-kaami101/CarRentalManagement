...
public class UpdateCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            adao.UpdateCustomer(id, fullName, email, phone, driverLicenseNumber, username, password);
            request.setAttribute("Update", "Cap nhat thong tin thanh cong");
