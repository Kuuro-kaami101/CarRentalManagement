                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:if test="${sessionScope.acc == 3}">
                            <li class="nav-item">
                                <a class="nav-link" href="ManageRentalControl?staffId=${staff.personnelId}">Đơn thuê xe</a>
                            </li>
                        </c:if>
                        <c:if test="${sessionScope.acc == 4}">
                            <li class="nav-item" style="display: flex">
                                <a class="nav-link" href="ManageAccountControl?cusId=${cus.customerId}">Tài khoản</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="ManageCart?cusId=${cus.customerId}">Đơn thuê xe</a>
                            </li>
                        </c:if>
                        <li class="nav-item">
                            <a class="nav-link">|</a>
