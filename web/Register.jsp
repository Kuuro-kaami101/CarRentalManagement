                ...
                <div class="container">
                    <div class="signup-content">
                        <form action="register" method="post" enctype="multipart/form-data" id="signup-form" class="signup-form">
                            ...
                            <div class="form-group">
                                <input type="password" name="re_password" id="re_password" required  placeholder="Xác nhận mật khẩu"/>
                                <span class="toggle-password" onclick="togglePasswordVisibility('re_password')"></span>
                            </div>
