...
<html>
    ...
    <style>
        ...
        .detail-car .detail-container .content-detail .info-car-basic {
            margin-bottom: 36px;
            height: 108px;
        }
        .detail-car .detail-container .content-detail .info-car-basic .group-name .shared {
            display: flex;
            align-items: center;
            grid-gap: 16px;
            gap: 16px;
        }
        .detail-car .detail-container .content-detail .info-car-basic .group-name .shared .wrap-ic {
            padding: 12px;
            border-radius: 100%;
            border: 1px solid #e0e0e0;
            cursor: pointer;
        }
        .detail-car .detail-container .content-detail .info-car-basic .group-total{
            display: flex;
            align-items: center;
            flex-wrap: wrap;
            width: 650px;
        ...
        .detail-car .detail-container .content-detail .info-car-basic .group-tag {
            display: flex;
            flex-wrap: wrap;
        }
        ...
        .detail-car .detail-container .sidebar-detail .rent-box {
            padding: 16px 8px;
            background: #f7fbff;
            border: 1px solid #f4f4f4;
            border-radius: 10px;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .price {
            margin: 0 0 16px;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form{
            margin-bottom: 12px;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form.error {
            border: 1px solid #f26a2b;
            border-radius: 10px;
            display: flex;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form.error .line {
            border-right: 1px solid #f26a2b;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form .form-item label{
            cursor: pointer;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form .form-item {
            padding: 12px 8px;
            width: 100%;
            padding: 5px;
            display: flex;
        ...
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form .form-item .wrap-date-time {
            display: flex;
            justify-content: space-between;
            color: #000;
            font-weight: 600;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .date-time-form .form-item .wrap-date-time .wrap-date input.form-control {
            border-radius: 5px;
            border: 1px solid;
            font-size: 14px;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .dropdown-form {
            position: relative;
            display: flex;
            flex-direction: column;
            grid-gap: 8px;
        ...
        .detail-car .detail-container .sidebar-detail .rent-box .price-container {
            display: flex;
            flex-direction: column;
            grid-gap: 8px;
            gap: 8px;
        ...
        .detail-car .detail-container .sidebar-detail .rent-box .price-container .price-item {
            display: flex;
            justify-content: space-between;
        }
        .detail-car .detail-container .sidebar-detail .rent-box .promotion {
            display: flex;
            grid-gap: 8px;
            gap: 8px;
            padding: 8px 16px;
                                ...
                                <div class="content-detail">
                                    <div class="infor-car-basic">
                                        ...
                                        <div class="group-total">
                                            ...
                                            <span class="dot">•</span>
                                            <span class="info">${location.address}</span>
                                        </div>
                                    ...
                                    <div class="rent-box" id="cardetail" style="position: relative;">
                                        <div class="price"><h4>${detail.cost}K/ngày</h4></div>
                                        <div class="date-time-form error" style="width:287px">
                                                <div class="form-item">
                                                    ...
                                                    <div class="wrap-date-time">
                                                        <div class="wrap-date">                                                      
                                                            <input class="form-control" id="checkin" name="check-in" type="date" style="width:132px" placeholder="Select Date" required>        
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="line"></div>
...
<!--                                                        <span class="value">05/06/2023</span>-->
                                                                 <input class="form-control" id="checkout" name="check-out" type="date" style="width:132px" placeholder="Select Date" required> 
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="calendar d-flex">
                                            <div class="wrap-svg" style="margin-bottom: 12px; margin-right: 5px;">
                                                ...
                                                </svg></div><p class="note text-danger">Xe bận trong khoảng thời gian trên. Vui lòng đặt xe khác hoặc thay đổi lịch trình thích hợp.</p>
                                        </div>
                                        <div class="dropdown-form ">
                                            <label>Địa điểm giao nhận xe</label>
                                            <div class="wrap-form has-arrow">
                                                <span class="value">Quận Bình Thạnh, Hồ Chí Minh</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="" style="margin-bottom:5px">
                                            ...
                                            <input type="text" class="form-control" id="name" name="cus" value="${cus.fullName}" required>
                                        </div>
                                        
                                        <div class="">
                                            <label for="hotel" class="form-label">Car</label>
                                            <input type="text" class="form-control" id="car" name="cus" value="${car.name}" required>
                                        </div>
...
<!--                                                        <span class="tooltip-text">Giá thuê xe được tính theo ngày, thời gian thuê ít hơn 24 tiếng sẽ được tính tròn 1&nbsp;ngày <br>Giá thuê xe không bao gồm tiền xăng. Khi kết thúc chuyến đi, bạn vui lòng đổ xăng về lại mức ban đầu như khi nhận xe</span></span></p>-->
                                                        <p class="cost" namm="cost">
                                            ...
                                            <div class="line-page"></div>
                                                <div class="promotion">
                                                    <div class="wrap-svg">
                                                        ...
                                                        <button class="btn btn-outline-primary" type="submit">Đặt xe</button><div >
