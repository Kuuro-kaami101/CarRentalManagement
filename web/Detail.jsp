...
<html>
    ...
    <body>
        ...
        <c:set var="transmission" value="" />
        <c:set var="fuel" value="" />
        <c:set var="consumption" value="" />
        <c:set var="shouldBreak" value="false" />
        <c:forEach items="${listLoca}" var="loca">
            <c:if test="${loca.locationId == car.locationId}">
                <c:set var="address" value="${loca.address}"/>
            </c:if>
        </c:forEach>
        <c:forEach items="${listCate}" var="cate">
            <c:if test="${cate.categoryId == car.categoryId}">
                <c:set var="category" value="${cate.title}"/>
            </c:if>
        </c:forEach>
        <c:forEach items="${listinfo}" var="li">
            <c:if test="${!shouldBreak}">
                <c:if test="${li.carinfoId == car.carinfoId}">
                    <c:set var="transmission" value="${li.transmission}" />
                    <c:set var="fuel" value="${li.fuel}" />
                    <c:set var="consumption" value="${li.consumption}" />
                            ...
                            <div class="detail-container" style="text-align: left">
                                ...
                                <div class="sidebar-detail">
                                    <form action="BookCarControl" method="get">
                                        ...
                                        <input name="carId" value="${car.carId}" type="hidden">
                                        <div class="rent-box" id="cardetail" style="position: relative;">
                                            <div class="date-time-form error" style="width:287px">
                                                <div class="form-item">
                                                    ...
                                                    <div class="wrap-date-time">
                                                        <div class="wrap-date">                                                      
                                                            <input class="form-control" id="checkin" name="check-in" type="date" style="width:132px" value="${startDate}" readonly required>        
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="line"></div>
                                                <div class="form-item">
                                                    ...
                                                    <div class="wrap-date-time">
                                                        <div class="wrap-date">
                                                            <input class="form-control" id="checkout" name="check-out" type="date" style="width:132px" value="${endDate}" readonly required> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown-form ">
                                                ...
                                                <div class="wrap-form has-arrow">
                                                    <input name="address" value="${car.locationId}" type="hidden"> 
                                                    <span>${address}</span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="price-item">
                                                    <p class="df-align-center">Đơn giá thuê
                                                        <span class="tooltip  ">
                                                            ...
                                                            <p class="cost">
                                                                <input name="cost" value="${car.pricePerDay}" type="hidden"> 
                                                                <span>${car.pricePerDay} 000đ/ngày</span>
                                                            </p>
                                                </div>
                                ...
                                <div class="content-detail">
                                    ...
                                    <div class="info-car-desc">
                                        ...
                                        <p class="df-align-center">${car.detail}</p>
                                    </div>
                                    <div class="line-page"></div>
                                    <div class="info-car-desc">
