                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <input value="${listCar.address}" name="address" type="text" class="form-control"readonly required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input value="${listCar.cost}" name="price" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                    <textarea name="status" class="form-control" required>${listCar.status}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Detail</label>
